...
Description: Stores email addresses from a custom signup form.
Version: 1.0
Author: Mert Korkmaz
*/
...
function save_signup_email() {
    ...
    wp_send_json_success('Thank you for signing up!');
}
...
function render_signup_admin_page() {
    ...
    echo '<div class="wrap"><h1>Registered Email Addresses</h1>';
    if ($results) {
        echo '<table class="widefat fixed" style="max-width:800px;"><thead><tr><th>#</th><th>Email Address</th><th>Date</th></tr></thead><tbody>';
